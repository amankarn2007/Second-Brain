...
function ShowLink(props: ShowLink) {
    ...
    return(
        <div className="w-150 h-15 rounded-2xl bg-blue-100 hover:bg-blue-200 flex items-center justify-center my-5 ml-15 shadow-lg shadow-cyan-200 hover:shadow-blue-300">
